...
;              
CREATE USER IF NOT EXISTS "SA" SALT '29d50364932e367a' HASH '472ac197e851597a17af2842a5c4e8ee2ae90ea646ab6cb59ec184bfdf3e8bc0' ADMIN;          
...
INSERT INTO "PUBLIC"."USERS"("USER_ID", "API_KEY", "AUTHENTICATIONTYPE", "ENABLED", "IS_FIRST_LOGIN", "PASSWORD", "ROLE_NAME", "USERNAME", "TEAM_ID") VALUES(1, NULL, 'web', TRUE, TRUE, '$2a$10$IxMzF2v72zXYQU20GXTi0OSAhWRb5u34VlT0aNA2fPkER8GNN49OC', NULL, 'admin', 1);    
INSERT INTO "PUBLIC"."USERS"("USER_ID", "API_KEY", "AUTHENTICATIONTYPE", "ENABLED", "IS_FIRST_LOGIN", "PASSWORD", "ROLE_NAME", "USERNAME", "TEAM_ID") VALUES(2, '07ab5bcc-291c-4cf3-979a-4ad975e59129', 'web', TRUE, FALSE, '$2a$10$FEcjKFpkMaGbu4gkaQTBteL4HGoZxtT0DGWE/5jcJuRTg9smUqc8W', NULL, 'STIRLING-PDF-BACKEND-API-USER', 2);         
