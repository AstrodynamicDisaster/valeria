...
if __name__ == "__main__":
    ...
    if len(sys.argv) < 2:
        print("Usage: python3 obtain_vl_employees_details.py <filepath.csv>")
        print("Example: python3 obtain_vl_employees_details.py vl_ccc.csv")
        sys.exit(1)
    ...
    try:
        employees_df = pd.read_csv(filepath, dtype={"ccc": str, "ipf": str})
        ...
        csv_filename = f"employees_{input_name_without_ext}.csv"
